 ...
 */
export function processTemplates(templateDirectory: string, currentChildDirectory: string, siteDirectory: string, templateValues: Object) {
  ...
  directories.forEach((directory) => {
    ...
    processTemplates(templateDirectory, `${currentChildDirectory}/${directory}`, siteDirectory, templateValues);
  });
}
